            ...
            >
              ...
              <div className="flex items-center justify-between w-full">
                <div className="flex flex-col gap-1">
                  ...
                  <div
                    style={{ backgroundColor: categories[meal.strCategory || selectedCategory] }}
                ...
                {isAuth &&
                  (bookmarks.some(
                    (bookmark) => bookmark.meal_id == meal.idMeal
                  ) ? (
                    <button className="p-4 text-orange-500 cursor-pointer">
                      <FaBookmark size={24} />
                    </button>
                  ) : (
                    <button
                      onClick={() => save(meal.idMeal)}
